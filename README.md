...
It requires Intellij IDEA Ultimate or Community Edition, and 2018.3.
...
To override the default, set the IDEA_VERSION environment variable prior to executing make.
...
- Open the Settings dialog (File->Settings...)
- Highlight "Plugins" in the leftmost column
 a- Click “Install plugin from disk...”
- Select the “intellij-logtalk.jar” file you downloaded
- Allow IDEA to restart and initialize the plugin.
