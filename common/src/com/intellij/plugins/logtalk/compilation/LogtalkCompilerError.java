...
import java.util.regex.Pattern;
   ...
   */
  public class LogtalkCompilerError {
    ...
    public LogtalkCompilerError(CompilerMessageCategory category, String errorMessage, String path, int line, int column) {
  ...
  @Nullable
  public static LogtalkCompilerError create(@NotNull String rootPath, final String message) {
    return create(rootPath, message, true);
  }

    @Nullable
    public static LogtalkCompilerError create(@NotNull String rootPath,
                                           ...
                                           boolean checkExistence)
    {
        ...
        if ((m = pLibraryNotInstalled.matcher(trimmed)).matches()) {
            return new LogtalkCompilerError(CompilerMessageCategory.ERROR,
        ...
        // match the pattern.
          ...
          if (matchesInformationalPattern(error)) {
            ...
            return new LogtalkCompilerError(CompilerMessageCategory.INFORMATION,
                                         message, null, -1, -1);
          }
        ...
        if (0 == text.indexOf(warningStr)) {
          ...
          return new LogtalkCompilerError(CompilerMessageCategory.WARNING,
    ...
    // Unfortunately, the Logtalk compiler doesn't always mark its error lines with
