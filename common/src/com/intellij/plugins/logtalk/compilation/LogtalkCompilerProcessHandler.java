 ...
 */
public class LogtalkCompilerProcessHandler extends ColoredProcessHandler implements AnsiEscapeDecoder.ColoredChunksAcceptor {

  static final String STDERR_PREFIX = "(stderr) ";

  final LogtalkCommonCompilerUtil.CompilationContext context;

  public LogtalkCompilerProcessHandler(@NotNull LogtalkCommonCompilerUtil.CompilationContext context, @NotNull Process process, /*@NotNull*/ String commandLine, @NotNull Charset charset) {
