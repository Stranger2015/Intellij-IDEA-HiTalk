 ...
 *
 */
public class LogtalkCommandLine extends GeneralCommandLine {

  public LogtalkCommandLine(@NotNull Module module) {
    super();
    addEnvironmentVars();
    patchPath(module);
  }

  public LogtalkCommandLine(@NotNull Module module, @NotNull String... command) {
    super(command);
    addEnvironmentVars();
    patchPath(module);
  }

  public LogtalkCommandLine(@NotNull Module module, @NotNull List<String> command) {
    super(command);
    addEnvironmentVars();
    patchPath(module);
  }
  ...
  public void patchPath(Module module) {
    LogtalkSdkAdditionalDataBase sdk = LogtalkSdkUtilBase.getSdkData(module);
    LogtalkSdkUtilBase.patchEnvironment(getEnvironment(), sdk);
  }
}
