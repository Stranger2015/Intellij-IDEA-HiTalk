 ...
 */
public class LogtalkSdkUtilBase {
  private static final Logger LOG = Logger.getInstance("#LogtalkSdkUtilBase");
  protected static final String COMPILER_EXECUTABLE_NAME = "logtalk";
  ...
  @Nullable
  public static String getLogtalklibPathByFolderPath(String folderPath) {
  ...
  @Nullable
  public static LogtalkSdkAdditionalDataBase getSdkData(@Nullable Module module) {
    if(module != null) {
  ...
  @Nullable
  public static LogtalkSdkAdditionalDataBase getSdkData(@Nullable Sdk sdk) {
    if(sdk != null) {
      SdkAdditionalData sdkData = sdk.getSdkAdditionalData();
      if(sdkData != null && sdkData instanceof LogtalkSdkAdditionalDataBase) {
        return (LogtalkSdkAdditionalDataBase)sdkData;
      }
    }
    return null;
  }
  ...
  @NotNull
  private static String getEnvironmentPathPatch(@Nullable LogtalkSdkAdditionalDataBase haxeSdkData) {
    String result = "";
    String pathsep = SystemInfo.isWindows ? ";" : ":";
    if(haxeSdkData != null) {
      final String sdkHome = haxeSdkData.getHomePath();
      final String haxelibBin = haxeSdkData.getLogtalklibPath();
  ...
  @NotNull
  public static ProcessBuilder createProcessBuilder(List<String> commandLine, @Nullable File workingDirectory, @Nullable LogtalkSdkAdditionalDataBase haxeSdkData) {
  ...
  /**
   * Patch the PATH environment variable to include the Logtalk SDK.  The original environment
   ...
   */
  @NotNull
  public static Map<String,String> patchEnvironment(@NotNull Map<String,String> env, @Nullable LogtalkSdkAdditionalDataBase haxeSdkData) {
