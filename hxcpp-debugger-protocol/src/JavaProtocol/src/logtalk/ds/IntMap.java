...
public  class IntMap<T> extends logtalk.lang.HxObject implements logtalk.root.IMap<java.lang.Object, T>
{
	public    IntMap(logtalk.lang.EmptyObject empty)
	{
		{
		}
	...
	public    IntMap()
	{
		logtalk.ds.IntMap.__hx_ctor_haxe_ds_IntMap(this);
	}
	
	
	public static  <T_c> void __hx_ctor_haxe_ds_IntMap(logtalk.ds.IntMap<T_c> __temp_me26)
	{
	...
	{
		return new logtalk.ds.IntMap<java.lang.Object>(((logtalk.lang.EmptyObject) (logtalk.lang.EmptyObject.EMPTY) ));
	}
	
	
	public static   java.lang.Object __hx_create(logtalk.root.Array arr)
	{
		return new logtalk.ds.IntMap<java.lang.Object>();
	}
	...
	{
		logtalk.root.Array<logtalk.ds.IntMap> _g1 = new logtalk.root.Array<logtalk.ds.IntMap>(new logtalk.ds.IntMap[]{((logtalk.ds.IntMap) (this) )});
		...
		{
			logtalk.lang.Function __temp_odecl136 = new logtalk.ds.IntMap_keys_332__Fun<T>(((logtalk.root.Array<java.lang.Object>) (i) ), ((logtalk.root.Array<logtalk.ds.IntMap>) (_g1) ), ((logtalk.root.Array<java.lang.Object>) (len) ));
			logtalk.lang.Function __temp_odecl137 = new logtalk.ds.IntMap_keys_343__Fun<T>(((logtalk.root.Array<java.lang.Object>) (i) ), ((logtalk.root.Array<logtalk.ds.IntMap>) (_g1) ));
			return new logtalk.lang.DynamicObject(new logtalk.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new logtalk.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl136, __temp_odecl137}), new logtalk.root.Array<java.lang.String>(new java.lang.String[]{}), new logtalk.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	{
		{
			...
			switch (field.hashCode())
			{
				...
				case -553141795:
				{
					...
					{
						__temp_executeDef139 = false;
						this.cachedKey = ((int) (logtalk.lang.Runtime.toInt(value)) );
						return value;
					}
	...
	{
		{
			...
			switch (field.hashCode())
			{
				...
				case 113762:
				{
					...
					{
						__temp_executeDef142 = false;
						this.set(((int) (logtalk.lang.Runtime.toInt(dynargs.__get(0))) ), ((T) (dynargs.__get(1)) ));
					}
				...
				case -1097094790:
				{
					...
					{
						__temp_executeDef142 = false;
						return this.lookup(((int) (logtalk.lang.Runtime.toInt(dynargs.__get(0))) ));
					}
				...
				case 102230:
				{
					...
					{
						__temp_executeDef142 = false;
						return this.get(((int) (logtalk.lang.Runtime.toInt(dynargs.__get(0))) ));
					}
