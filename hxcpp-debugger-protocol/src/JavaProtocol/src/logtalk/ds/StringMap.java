...
public  class StringMap<T> extends logtalk.lang.HxObject implements logtalk.root.IMap<java.lang.String, T>
{
	public    StringMap(logtalk.lang.EmptyObject empty)
	{
		{
		}
	...
	public    StringMap()
	{
		logtalk.ds.StringMap.__hx_ctor_haxe_ds_StringMap(this);
	}
	
	
	public static  <T_c> void __hx_ctor_haxe_ds_StringMap(logtalk.ds.StringMap<T_c> __temp_me28)
	{
	...
	{
		return new logtalk.ds.StringMap<java.lang.Object>(((logtalk.lang.EmptyObject) (logtalk.lang.EmptyObject.EMPTY) ));
	}
	
	
	public static   java.lang.Object __hx_create(logtalk.root.Array arr)
	{
		return new logtalk.ds.StringMap<java.lang.Object>();
	}
		...
		int[] hashes1 = hashes;
		{
			 ...
			 else 
			{
				...
				do 
				{
					...
					if ( ! (__temp_stmt163) ) 
					{
						__temp_boolv164 = (( flag == k ) && logtalk.lang.Runtime.valEq(this._keys[i], key) );
					}
	...
	public   int lookup(java.lang.String key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				...
				if (__temp_boolv167) 
				{
					__temp_boolv166 = (( ( ( flag == 1 ) || ( flag != k ) ) ||  ! (logtalk.lang.Runtime.valEq(keys[i], key))  ));
				}
	...
	{
		int idx = -1;
		if ((logtalk.lang.Runtime.valEq(this.cachedKey, key) && ((idx = this.cachedIndex) != -1 ) ))
		{
	...
	{
		logtalk.root.Array<logtalk.ds.StringMap> _g1 = new logtalk.root.Array<logtalk.ds.StringMap>(new logtalk.ds.StringMap[]{((logtalk.ds.StringMap) (this) )});
		...
		{
			logtalk.lang.Function __temp_odecl174 = new logtalk.ds.StringMap_keys_356__Fun<T>(((logtalk.root.Array<java.lang.Object>) (i) ), ((logtalk.root.Array<logtalk.ds.StringMap>) (_g1) ), ((logtalk.root.Array<java.lang.Object>) (len) ));
			logtalk.lang.Function __temp_odecl175 = new logtalk.ds.StringMap_keys_367__Fun<T>(((logtalk.root.Array<java.lang.Object>) (i) ), ((logtalk.root.Array<logtalk.ds.StringMap>) (_g1) ));
			return new logtalk.lang.DynamicObject(new logtalk.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new logtalk.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl174, __temp_odecl175}), new logtalk.root.Array<java.lang.String>(new java.lang.String[]{}), new logtalk.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	{
		{
			...
			switch (field.hashCode())
			{
				...
				case -553141795:
				{
					...
					{
						__temp_executeDef177 = false;
						this.cachedKey = logtalk.lang.Runtime.toString(value);
						return value;
					}
	...
	{
		{
			...
			switch (field.hashCode())
			{
				...
				case 113762:
				{
					...
					{
						__temp_executeDef180 = false;
						this.set(logtalk.lang.Runtime.toString(dynargs.__get(0)), ((T) (dynargs.__get(1)) ));
					}
				...
				case 102230:
				{
					...
					{
						__temp_executeDef180 = false;
						return this.get(logtalk.lang.Runtime.toString(dynargs.__get(0)));
					}
				...
				case -1097094790:
				{
					...
					{
						__temp_executeDef180 = false;
						return this.lookup(logtalk.lang.Runtime.toString(dynargs.__get(0)));
					}
