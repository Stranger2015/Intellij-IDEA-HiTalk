...
public  class StringExt
{
	...
	public static   int indexOf(java.lang.String me, java.lang.String str, java.lang.Object startIndex)
	{
			...
			int sIndex = (startIndex != null ) ? (logtalk.lang.Runtime.toInt(startIndex)) : 0;
	...
	public static   int lastIndexOf(java.lang.String me, java.lang.String str, java.lang.Object startIndex)
	{
			...
			int sIndex = (startIndex != null ) ? (logtalk.lang.Runtime.toInt(startIndex)) : (me.length() - 1);
			if (sIndex > me.length() || sIndex < 0)
				sIndex = me.length() - 1;
			else if (sIndex < 0)
				return -1;
	...
	public static   logtalk.root.Array<java.lang.String> split(java.lang.String me, java.lang.String delimiter)
	{
	...
	public static   java.lang.String substr(java.lang.String me, int pos, java.lang.Object len)
	{
			...
			if (len != null)
			{
				targetLen = logtalk.lang.Runtime.toInt(len);
				if (targetLen == 0)
					return "";
	...
	public static   java.lang.String substring(java.lang.String me, int startIndex, java.lang.Object endIndex)
	{
		...
		if ( endIndex == null) {
			endIdx = len;
		} else if ((endIdx = logtalk.lang.Runtime.toInt(endIndex)) < 0 ) {
			endIdx = 0;
		} else if ( endIdx > len ) {
			endIdx = len;
		}
