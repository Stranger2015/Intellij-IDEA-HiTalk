...
public  class StringRefl
{
	static 
	{
          logtalk.lang.StringRefl.fields = new logtalk.root.Array<java.lang.String>(new java.lang.String[]{"length", "toUpperCase", "toLowerCase", "charAt", "charCodeAt", "indexOf", "lastIndexOf", "split", "substr", "substring"});
	}
	public    StringRefl()
	{
		{
	...
	public static  logtalk.root.Array<java.lang.String> fields;
	...
	{
		{
			...
			switch (__temp_hash204)
			{
				...
				case 530542161:case -891529231:case 109648666:case -467511597:case 1943291465:case 397153782:case -1361633751:case -1137582698:case -399551817:
				{
					...
					{
						__temp_executeDef203 = false;
						return new logtalk.lang.Closure(((java.lang.Object) (str) ), logtalk.lang.Runtime.toString(f));
					}
			...
			if (__temp_executeDef203) 
			{
				if (throwErrors) 
				{
					throw logtalk.lang.LogtalkException.wrap((("Field not found: \'" + f ) + "\' in String" ));
				}
				 else 
				{
					return null;
	...
	public static   java.lang.Object handleCallField(java.lang.String str, java.lang.String f, logtalk.root.Array args)
	{
		logtalk.root.Array _args = new logtalk.root.Array(new java.lang.Object[]{str});
		if (( args == null )) 
		{
			args = _args;
		}
		...
		return logtalk.lang.Runtime.slowCallField(logtalk.lang.StringExt.class, f, args);
	}
