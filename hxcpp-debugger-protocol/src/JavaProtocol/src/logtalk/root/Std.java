...
public  class Std
{
	...
	public static   boolean is(java.lang.Object v, java.lang.Object t)
	{
		if (( v == null )) 
		{
			return logtalk.lang.Runtime.eq(t, java.lang.Object.class);
		}
		...
		java.lang.String name = clt.getName();
		{
			...
			switch (__temp_hash79)
			{
				case 761287205:case -1325958191:
				{
					...
					{
						return logtalk.lang.Runtime.isDouble(v);
					}
				...
				case -2056817302:case 104431:
				{
					...
					{
						return logtalk.lang.Runtime.isInt(v);
					}
	...
	{
		return (logtalk.lang.Runtime.toString(s) + "" );
	}
