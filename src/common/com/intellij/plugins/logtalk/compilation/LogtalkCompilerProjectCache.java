 ...
 * (For example, when the Logtalk project target is OpenFL, lime is run to extract
 ...
 */
public class LogtalkCompilerProjectCache {
  ...
  private class cacheEntry {
    ...
    public LogtalkTrackedModifiable.Stamp moduleStamp;
    public LogtalkTrackedModifiable.Stamp projectStamp;
    ...
    public void init(Module module, String projectFile, String target, List<String> args) {
      ...
      moduleStamp = null != module ? LogtalkModuleSettings.getInstance(module).getStamp() : LogtalkTrackedModifiable.INVALID_STAMP;
      projectStamp = null != module ? LogtalkProjectSettings.getInstance(module.getProject()).getStamp() : LogtalkTrackedModifiable.INVALID_STAMP;
    }
  }


  public LogtalkCompilerProjectCache() {
    myCacheEntry = null;
