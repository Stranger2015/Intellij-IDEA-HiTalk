...
import com.intellij.plugins.logtalk.util.LogtalkProcessUtil;
 ...
 */
public class LogtalkCompilerUtil
{
    static LogtalkDebugLogger LOG = LogtalkDebugLogger.getLogger();
    ...
    /**
     * Verify that the Logtalk project file (.xml, .nmml, etc.; NOT an IDEA project file)
    ...
    private static void addErrorToContext(String error, CompileContext context,
                                          String errorRoot)
    {
        // TODO: Add a button to the Logtalk module settings to control whether we always open the window or not.
        ...
        final LogtalkCompilerError compilerError = LogtalkCompilerError.create
            (errorRoot,
             error,
    ...
    public static VirtualFile findCompileRoot(@NotNull PsiFile file) {
        ...
        // TODO: Add a "compile directory" to the Logtalk module settings.
    ...
    /**
     * Run an interruptible process with the Logtalk SDK compiler environment.  Checks
    ...
    public static int runInterruptibleCompileProcess(List<String> command,
                                                     boolean mixedOutput,
                                                     VirtualFile dir,
                                                     LogtalkSdkAdditionalDataBase sdkData,
                                        /*modifies*/ List<String> stdout,
                                        /*modifies*/ List<String> stderr,
                                                     LogtalkDebugTimeLog timeLog) {
        return LogtalkProcessUtil.runProcess(command, mixedOutput, dir, sdkData, stdout, stderr, timeLog, true);
    }


    public static String calculateCompilerOutput(@NotNull Module module) {
        LogtalkCommonCompilerUtil.CompilationContext context = LogtalkCompiler.createDummyCompilationContext(module);
        return LogtalkCommonCompilerUtil.calculateOutputPath(context);
    }
}
