 ...
 */
package com.intellij.plugins.logtalk.config.ui;
 ...
 */
public class LogtalkSettingsForm {
  ...
  public boolean isModified(LogtalkProjectSettings settings) {
  ...
  public void applyEditorTo(LogtalkProjectSettings settings) {
    settings.setUserCompilerDefinitions(myAddDeleteListPanel.getItems());
  }

  public void resetEditorFrom(LogtalkProjectSettings settings) {
  ...
  private void createUIComponents() {
    myAddDeleteListPanel = new MyAddDeleteListPanel(LogtalkBundle.message("logtalk.conditional.compilation.defined.macros"));
  }
