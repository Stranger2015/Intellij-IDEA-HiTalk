...
import com.intellij.plugins.haxe.lang.psi.LogtalkPsiToken;
import com.intellij.plugins.logtalk.LogtalkLanguage;
import com.intellij.plugins.logtalk.lang.psi.LogtalkPsiToken;
 ...
 */
public class LogtalkStringSelectioner extends ExtendWordSelectionHandlerBase {

  @Override
  public boolean canSelect(PsiElement e) {
    return (e instanceof LogtalkPsiToken
            && e.getLanguage().equals(LogtalkLanguage.INSTANCE)
            && LogtalkTokenTypes.REGULAR_STRING_PART.equals(((LogtalkPsiToken)e).getTokenType()));
  }
