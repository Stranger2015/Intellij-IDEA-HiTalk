 ...
 */
public class LogtalkSmartEnterProcessor extends SmartEnterProcessor {
  private static final Logger LOG = Logger.getInstance("#com.intellij.plugins.logtalk.editor.smartEnter.LogtalkSmartEnterProcessor");
  ...
  public void setSkipEnter(boolean skipEnter) {
    LogtalkSmartEnterProcessor.skipEnter = skipEnter;
  }
  ...
  public boolean process(@NotNull Project project, @NotNull Editor editor, @NotNull PsiFile psiFile) {
    ...
    while (psiElement != null && !(psiElement instanceof LogtalkFile)) {
