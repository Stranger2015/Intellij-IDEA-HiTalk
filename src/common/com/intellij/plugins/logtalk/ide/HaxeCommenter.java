 ...
 */
public class LogtalkCommenter implements CodeDocumentationAwareCommenter {
  ...
  public IElementType getLineCommentTokenType() {
    return LogtalkTokenTypeSets.MSL_COMMENT;
  }

  @Override
  public IElementType getBlockCommentTokenType() {
    return LogtalkTokenTypeSets.MML_COMMENT;
  }

  @Override
  public IElementType getDocumentationCommentTokenType() {
    return LogtalkTokenTypeSets.DOC_COMMENT;
  }
  ...
  public boolean isDocumentationComment(PsiComment element) {
    return element.getTokenType() == LogtalkTokenTypeSets.DOC_COMMENT;
  }
}
