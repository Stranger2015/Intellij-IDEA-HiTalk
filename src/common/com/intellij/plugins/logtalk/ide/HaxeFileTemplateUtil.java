 ...
 */
public class LogtalkFileTemplateUtil {
  private final static String HAXE_TEMPLATE_PREFIX = "Logtalk";
  ...
  public static List<FileTemplate> getApplicableTemplates() {
    return getApplicableTemplates(new Condition<FileTemplate>() {
      ...
      public boolean value(FileTemplate fileTemplate) {
        return LogtalkFileType.DEFAULT_EXTENSION.equals(fileTemplate.getExtension());
      }
    });
  }
