...
public class LogtalkFindUsagesHandler extends FindUsagesHandler {

  public static final PsiElement[] NO_ELEMENTS = {};

  private final PsiElement[] extraElementsToSearch;

  protected LogtalkFindUsagesHandler(@NotNull PsiElement psiElement) {
    this(psiElement, NO_ELEMENTS);
  }

  protected LogtalkFindUsagesHandler(@NotNull PsiElement psiElement, @Nullable PsiElement[] others) {
    super(psiElement);
