...
public class LogtalkSymbolContributor implements ChooseByNameContributor {
  @NotNull
  @Override
  public String[] getNames(@NotNull final Project project, final boolean includeNonProjectItems) {
    final GlobalSearchScope scope = includeNonProjectItems ? GlobalSearchScope.allScope(project) : GlobalSearchScope.projectScope(project);
    return LogtalkSymbolIndex.getAllSymbols(scope);
  }
  ...
  public NavigationItem[] getItemsByName(@NotNull final String name,
    ...
    final GlobalSearchScope scope = includeNonProjectItems ? GlobalSearchScope.allScope(project) : GlobalSearchScope.projectScope(project);
    final Collection<LogtalkComponentName> result = LogtalkSymbolIndex.getItemsByName(name, project, scope);
