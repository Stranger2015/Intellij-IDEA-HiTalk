...
public class LogtalkTargetElementEvaluator extends TargetElementEvaluatorEx2 {
  @Nullable
  @Override
  public PsiElement adjustReferenceOrReferencedElement(PsiFile file,
    ...
    if (ref != null && refElement != null) {
      if (refElement instanceof LogtalkClass) {
        boolean isInNewExpression = PsiTreeUtil.getParentOfType(ref.getElement(), LogtalkNewExpression.class) != null;
        if (isInNewExpression) {
          LogtalkClassModel classModel = ((LogtalkClass)refElement).getModel();
