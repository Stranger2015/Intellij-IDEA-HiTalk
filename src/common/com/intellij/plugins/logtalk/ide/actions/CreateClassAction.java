...
public class CreateClassAction extends CreateTemplateInPackageAction<PsiFile> {
  ...
  public CreateClassAction() {
    super(LogtalkBundle.message("action.create.new.class"), LogtalkBundle.message("action.create.new.class"), icons.LogtalkIcons.Logtalk_16, SOURCES);
  }
  ...
  protected String getActionName(PsiDirectory directory, String newName, String templateName) {
    return LogtalkBundle.message("progress.creating.class", newName);
  }

  @Override
  protected void buildDialog(Project project, PsiDirectory directory, CreateFileFromTemplateDialog.Builder builder) {
    builder.setTitle(IdeBundle.message("action.create.new.class"));
    for (FileTemplate fileTemplate : LogtalkFileTemplateUtil.getApplicableTemplates()) {
      final String templateName = fileTemplate.getName();
      final String shortName = LogtalkFileTemplateUtil.getTemplateShortName(templateName);
      final Icon icon = LogtalkFileTemplateUtil.getTemplateIcon(templateName);
  ...
  private static PsiElement createClass(String className, String packageName, @NotNull PsiDirectory directory, final String templateName)
    throws Exception {
    return LogtalkFileTemplateUtil.createClass(className, packageName, directory, templateName, CreateClassAction.class.getClassLoader());
  }
}
