...
public class LogtalkCompilerCompletionItem {
  public static final List<LogtalkCompilerCompletionItem> EMPTY_LIST = new ArrayList<LogtalkCompilerCompletionItem>(0);
  ...
  public LogtalkCompilerCompletionItem(String name) {
    this.name = name;
  }
  ...
  public LookupElement toLookupElement() {
    ...
    Icon icon = "var".equals(this.memberType) ? LogtalkIcons.Field_Logtalk : LogtalkIcons.Method_Logtalk;
  ...
  public boolean equals(Object o) {
    ...
    LogtalkCompilerCompletionItem item = (LogtalkCompilerCompletionItem)o;
