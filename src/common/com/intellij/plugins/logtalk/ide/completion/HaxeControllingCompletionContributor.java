 ...
 * should be loaded first, before all other Logtalk contributors.
 *
 * Created by ebishton on 2/23/17.
 */
public class LogtalkControllingCompletionContributor extends CompletionContributor {

  static final LogtalkDebugLogger LOG = LogtalkDebugLogger.getInstance("#LogtalkControllingCompletionContributor");

  public LogtalkControllingCompletionContributor() {
    ...
    Arrays.sort(sorted, new Comparator<CompletionResult>() {
      ...
      public int compare(CompletionResult o1, CompletionResult o2) {
        ...
        if (0 == comp) {
          ...
          comp = obj1 instanceof LogtalkCompilerCompletionItem
                 ? (obj2 instanceof LogtalkCompilerCompletionItem ? 0 : -1)
                 : (obj2 instanceof LogtalkCompilerCompletionItem ? 1 : 0);
        }
        return comp;
      }
    });
