 ...
 */
public class LogtalkCodeStyleSettings extends CustomCodeStyleSettings {
  ...
  protected LogtalkCodeStyleSettings(CodeStyleSettings container) {
    super("LogtalkCodeStyleSettings", container);
  }
}
