 ...
 */
public class LogtalkCodeStyleSettingsProvider extends CodeStyleSettingsProvider {
  @Override
  ...
  public Configurable createSettingsPage(CodeStyleSettings settings, CodeStyleSettings originalSettings) {
    return new LogtalkCodeStyleConfigurable(settings, originalSettings);
  }

  @Nullable
  @Override
  public CustomCodeStyleSettings createCustomSettings(CodeStyleSettings settings) {
    return new LogtalkCodeStyleSettings(settings);
  }
}
