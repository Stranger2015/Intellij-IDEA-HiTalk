 ...
 */
public class LogtalkLanguageCodeStyleSettingsProvider extends LanguageCodeStyleSettingsProvider {
  ...
  public void customizeSettings(@NotNull CodeStyleSettingsCustomizable consumer, @NotNull SettingsType settingsType) {
    if (settingsType == SettingsType.SPACING_SETTINGS) {
      ...
      consumer.showCustomOption(LogtalkCodeStyleSettings.class, "SPACE_AROUND_ARROW", "Around ->",
                                CodeStyleSettingsCustomizable.SPACES_OTHER, CodeStyleSettingsCustomizable.OptionAnchor.NONE);
      consumer.showCustomOption(LogtalkCodeStyleSettings.class, "SPACE_BEFORE_TYPE_REFERENCE_COLON", "Space before type reference colon ':'",
                                CodeStyleSettingsCustomizable.SPACES_OTHER, CodeStyleSettingsCustomizable.OptionAnchor.NONE);
      consumer.showCustomOption(LogtalkCodeStyleSettings.class, "SPACE_AFTER_TYPE_REFERENCE_COLON", "Space after type reference colon ':'",
                                CodeStyleSettingsCustomizable.SPACES_OTHER, CodeStyleSettingsCustomizable.OptionAnchor.NONE);
    }
