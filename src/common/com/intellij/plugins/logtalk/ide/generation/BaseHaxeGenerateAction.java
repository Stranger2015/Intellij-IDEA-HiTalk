 ...
 */
public abstract class BaseLogtalkGenerateAction extends AnAction {
  ...
  protected abstract BaseLogtalkGenerateHandler getGenerateHandler();
  ...
  public void update(final AnActionEvent e) {
    ...
    final boolean inClass = psiFile != null && PsiTreeUtil.getParentOfType(psiFile.findElementAt(caretOffset), LogtalkClass.class) != null;
