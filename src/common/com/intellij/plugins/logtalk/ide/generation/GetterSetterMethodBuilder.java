...
public class GetterSetterMethodBuilder {
  public static void buildGetter(StringBuilder result, LogtalkFieldModel field) {
    build(result, field, true);
  }

  public static void buildSetter(StringBuilder result, LogtalkFieldModel field) {
    build(result, field, false);
  }

  public static void build(StringBuilder result, LogtalkFieldModel namedComponent, boolean isGetter) {
    ...
    result.append(isGetter ? LogtalkPresentableUtil.getterName(name) : LogtalkPresentableUtil.setterName(name));
    result.append("(");
    if (!isGetter) {
      result.append("value");
