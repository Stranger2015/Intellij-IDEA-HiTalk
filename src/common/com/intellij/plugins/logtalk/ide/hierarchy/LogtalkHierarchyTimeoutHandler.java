 ...
 *
 */
final public class LogtalkHierarchyTimeoutHandler {

  private static final boolean DEBUG = false;
  private static final Logger LOG = Logger.getInstance("#com.intellij.ide.hierarchy.LogtalkHierarchyTimeoutHandler");
   ...
   */
  public LogtalkHierarchyTimeoutHandler() {
    startTime = System.currentTimeMillis();
    stopTime = 0;
    canceled = false;
    stopped = false;
    final LogtalkHierarchyTimeoutHandler myself = this;
  ...
  public synchronized void cancel(@Nullable ProgressIndicator progressIndicator) {
    if (!canceled) {
      ...
      LogtalkDebugTimeLog.logStamp(LOG, "Canceling hierarchy request. Took too long.");
