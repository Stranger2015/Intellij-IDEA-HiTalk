...
import com.intellij.plugins.logtalk.lang.psi.impl.AbstractLogtalkPsiClass;
import com.intellij.plugins.logtalk.lang.psi.impl.AnonymousLogtalkTypeImpl;
 ...
 */
public class LogtalkHierarchyUtils {
  private static final Logger LOG = Logger.getInstance("#com.intellij.ide.hierarchy.LogtalkHierarchyUtils");
   ...
   */
  @Nullable
  public static LogtalkClass findReferencedClassForId(@NotNull LeafPsiElement id) {
    if (null == id) {
      return null;
    }
    ...
    return ((resolved instanceof LogtalkClass) ? ((LogtalkClass) resolved) : null);
  }
   ...
   */
  public static LogtalkClass[] getClassList(@NotNull LogtalkFile psiRoot) {

    ArrayList<LogtalkClass> classes = new ArrayList<>();
    for (PsiElement child : psiRoot.getChildren()) {
      if (child instanceof LogtalkClass) {
        classes.add((LogtalkClass)child);
      }
    }
    LogtalkClass[] return_type = {};
   ...
   */
  @Nullable
  public static AbstractLogtalkPsiClass getContainingClass(@NotNull DataContext context, boolean allowAnonymous) {
    if (LOG.isDebugEnabled()) {
    ...
    if (editor != null) {
      ...
      if (targetElement instanceof AbstractLogtalkPsiClass) {
        return (AbstractLogtalkPsiClass)targetElement;
      }
      ...
      while (element != null) {
        ...
        if (element instanceof AbstractLogtalkPsiClass) {
          // Keep looking if we don't allow anonymous classes.
          if (allowAnonymous || !(element instanceof AnonymousLogtalkTypeImpl)) {
            return (AbstractLogtalkPsiClass)element;
          }
        }
      ...
      return element instanceof AbstractLogtalkPsiClass ? (AbstractLogtalkPsiClass)element : null;
    }
  }
   ...
   */
  @Nullable
  public static LogtalkFile getContainingFile(@NotNull DataContext context) {
    if (LOG.isDebugEnabled()) {
   ...
   */
  @Nullable
  public static LogtalkMethod getTargetMethod(@NotNull DataContext context) {
    ...
    if (null == editor) {
      ...
      final PsiElement element = CommonDataKeys.PSI_ELEMENT.getData(context);
      return element instanceof LogtalkMethod ? (LogtalkMethod) element : null;
    }
    ...
    if (targetElement instanceof LogtalkMethod) {
      LOG.debug("target element " + targetElement);
      return ((LogtalkMethod) targetElement);
    }
    ...
    while (element != null) {
      ...
      if (element instanceof LogtalkMethod) {
          return ((LogtalkMethod)element);
      }
      element = element.getParent();
    }
   ...
   */
  @Nullable
  public static LogtalkClass resolveClassReference(@NotNull LogtalkReference element) {
    LogtalkClassResolveResult result = element.resolveLogtalkClass();
  ...
  public static boolean cannotBeOverriding(final PsiMethod method) {
    // Note that in Logtalk, a private method can override another private
...
} // END class LogtalkHierarchyUtils
