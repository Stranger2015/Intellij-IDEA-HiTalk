 ...
 */
public class LogtalkCallHierarchyProvider implements HierarchyProvider {
  private static final Logger LOG = Logger.getInstance("#com.intellij.ide.hierarchy.type.LogtalkCallHierarchyProvider");

  static {
    LOG.info("Loaded LogtalkCallHierarchyProvider");
  ...
  public HierarchyBrowser createHierarchyBrowser(PsiElement element) {
    ...
    return new LogtalkCallHierarchyBrowser(element.getProject(), (PsiMethod) element);
  }
