 ...
 */
public class LogtalkCallerMethodsTreeStructure extends HierarchyTreeStructure {

  private static final boolean DEBUG = false;
  private static final Logger LOG = Logger.getInstance("#com.intellij.plugins.logtalk.ide.hierarchy.LogtalkCallerMethodsTreeStructure");
  static {
    if (DEBUG) {
   ...
   */
  public LogtalkCallerMethodsTreeStructure(@NotNull Project project, @NotNull PsiMethod method, final String scopeType) {
  ...
  protected final Object[] buildChildrenInternal(@NotNull final HierarchyNodeDescriptor descriptor) {
    ...
    // final LogtalkDebugTimeLog timeLog = LogtalkDebugTimeLog.startNew("buildChildren", LogtalkDebugTimeLog.Since.StartAndPrevious);
    ...
    try {
      ...
      for (final PsiMethod methodToFind : methodsToFind) {
        final LogtalkCallReferenceProcessor.CallData data =
          new LogtalkCallReferenceProcessor.CallData(originalClass, methodToFind, originalType, method, methodsToFind,
