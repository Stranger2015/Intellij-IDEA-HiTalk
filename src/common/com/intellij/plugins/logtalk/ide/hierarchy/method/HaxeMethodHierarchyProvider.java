 ...
 */
public class LogtalkMethodHierarchyProvider implements HierarchyProvider {
  private static final Logger LOG = Logger.getInstance("#com.intellij.ide.hierarchy.type.LogtalkMethodHierarchyProvider");

  {
    LOG.info("Loaded LogtalkMethodHierarchyProvider");
  ...
  public PsiElement getTarget(@NotNull DataContext context) {
    ...
    LogtalkMethod foundMethod = LogtalkHierarchyUtils.getTargetMethod(context);
    return foundMethod;
  }
  ...
  public HierarchyBrowser createHierarchyBrowser(PsiElement element) {
    ...
    return new LogtalkMethodHierarchyBrowser(element.getProject(), (PsiMethod) element);
  }
