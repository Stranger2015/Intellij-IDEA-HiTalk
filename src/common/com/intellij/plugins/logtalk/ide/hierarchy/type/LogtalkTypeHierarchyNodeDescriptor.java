 ...
 */
final public class LogtalkTypeHierarchyNodeDescriptor extends LogtalkHierarchyNodeDescriptor {

  public LogtalkTypeHierarchyNodeDescriptor(final Project project,
  ...
  public final boolean update() {
    ...
    final LogtalkClass haxePsiClass = getLogtalkClass();
    ...
    final boolean isNonPrimaryClassOfTheFile = ((! (haxePsiClass instanceof LogtalkExternClassDeclaration)) &&
                                                (! (noExtensionFilename.equals(haxePsiClass.getName()))) &&
                                                (LogtalkResolveUtil.findComponentDeclaration(psiFile, noExtensionFilename) != null));

    String packageScopeStr = "";
    final String packageStr = LogtalkResolveUtil.getPackageName(psiFile);
