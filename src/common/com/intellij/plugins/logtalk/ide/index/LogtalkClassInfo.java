 ...
 */
public class LogtalkClassInfo {
  @NotNull private final String value;
  @Nullable private final LogtalkComponentType type;

  public LogtalkClassInfo(@NotNull String name, @Nullable LogtalkComponentType type) {
    value = name;
    this.type = type;
  }
  ...
  @Nullable
  public LogtalkComponentType getType() {
    return type;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if(obj != null && obj.getClass() == getClass()) {
      final LogtalkClassInfo info = (LogtalkClassInfo)obj;
