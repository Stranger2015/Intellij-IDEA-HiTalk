 ...
 */
public class LogtalkComponentFileNameIndex extends ScalarIndexExtension<String> {
  public static final ID<String, Void> HAXE_COMPONENT_FILE_NAME_INDEX = ID.create("LogtalkComponentFileNameIndex");
  private static final int INDEX_VERSION = LogtalkIndexUtil.BASE_INDEX_VERSION + 4;
  private DataIndexer<String, Void, FileContent> myDataIndexer = new MyDataIndexer();

  /** The list of files searched in dumb mode.  (Always empty.) */
  public static List<VirtualFile> DUMB_MODE_LIST = new ArrayList<>();
  ...
  private static class MyDataIndexer implements DataIndexer<String, Void, FileContent> {
    ...
    public Map<String, Void> map(final FileContent inputData) {
      ...
      if(!moduleAdded) {
        String mainModuleName = LogtalkResolveUtil.joinQName(LogtalkResolveUtil.getPackageName(psiFile), moduleName);
