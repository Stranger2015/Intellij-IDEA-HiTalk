 ...
 **/
public class LogtalkDeprecatedInspection extends LocalInspectionTool {
  @NotNull
  ...
  public String getDisplayName() {
    return LogtalkBundle.message("logtalk.inspection.deprecated.symbol");
  }
  ...
  public String getShortName() {
    return "LogtalkDeprecatedSymbol";
  }
  ...
  public ProblemDescriptor[] checkFile(@NotNull PsiFile file, @NotNull final InspectionManager manager, final boolean isOnTheFly) {
    ...
    new LogtalkAnnotatingVisitor() {
      @Override
      protected void handleDeprecatedFunctionDeclaration(@NotNull LogtalkFunctionDeclarationWithAttributes function) {
