...
import com.intellij.plugins.haxe.lang.psi.LogtalkStringLiteralExpression;
...
public class ConvertQuotesIntention extends BaseIntentionAction {
  ...
  private LogtalkStringLiteralExpression expression;
  ...
  public boolean isAvailable(@NotNull Project project, Editor editor, PsiFile file) {
    ...
    expression = PsiTreeUtil.getParentOfType(place, LogtalkStringLiteralExpression.class);
      ...
      new Runnable() {
        ...
        public void run() {
          new WriteCommandAction.Simple(project) {
            @Override
            public void run() {
              final LogtalkDocumentModel document = LogtalkDocumentModel.fromElement(expression);
  ...
  private boolean canSwitchQuotes(LogtalkStringLiteralExpression expression) {
  ...
  private boolean isWrappedWithDoubleQuotes(LogtalkStringLiteralExpression expression) {
