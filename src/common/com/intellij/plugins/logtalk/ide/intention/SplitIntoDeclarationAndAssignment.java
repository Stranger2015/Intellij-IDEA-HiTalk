...
public class SplitIntoDeclarationAndAssignment implements IntentionAction {
  ...
  public boolean isAvailable(@NotNull Project project, Editor editor, PsiFile file) {
    ...
    LogtalkLocalVarDeclaration localVarDeclaration = PsiTreeUtil.getParentOfType(elementAt, LogtalkLocalVarDeclaration.class);
    if (localVarDeclaration != null) {
      LogtalkVarInit varInit = localVarDeclaration.getVarInit();
  ...
  public void invoke(@NotNull Project project, Editor editor, PsiFile file) throws IncorrectOperationException {
    ...
    LogtalkTypeTag typeTag = localVarDeclaration.getTypeTag();
    LogtalkVarInit varInit = localVarDeclaration.getVarInit();
    ...
    text += ";";
    LogtalkVarDeclaration varDeclaration = LogtalkElementGenerator.createVarDeclaration(project, text);
    text = name + varInit.getText();

    varDeclaration.getNode().addLeaf(LogtalkTokenTypes.OSEMI, "\n", null);
    PsiElement statementFromText = LogtalkElementGenerator.createStatementFromText(project, text);
    statementFromText.getNode().addLeaf(LogtalkTokenTypes.OSEMI, ";", null);
