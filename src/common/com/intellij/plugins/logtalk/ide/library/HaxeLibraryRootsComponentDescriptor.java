 ...
 */
public class LogtalkLibraryRootsComponentDescriptor extends LibraryRootsComponentDescriptor {
  @Override
  ...
  public List<? extends RootDetector> getRootDetectors() {
    return Arrays.asList(
      new LogtalkLibRootDetector(OrderRootType.SOURCES, LogtalkBundle.message("sources.root.detector.sources.name")),
      new LogtalkLibRootDetector(OrderRootType.CLASSES, LogtalkBundle.message("sources.root.detector.classes.name"))
    );
  }
