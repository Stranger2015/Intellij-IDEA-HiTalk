...
import com.intellij.plugins.haxe.ide.index.LogtalkIndexUtil;
import com.intellij.plugins.haxe.lang.psi.LogtalkClass;
import com.intellij.plugins.haxe.lang.psi.LogtalkClassResolveCache;
 ...
 * @author traff
 */
public class TreeLogtalkClassChooserDialog extends AbstractTreeClassChooserDialog<PsiClass> implements TreeClassChooser {
  public TreeLogtalkClassChooserDialog(String title, Project project) {
    super(title, project, PsiClass.class);
  }

  public TreeLogtalkClassChooserDialog(String title, Project project, @Nullable PsiClass initialClass) {
    super(title, project, PsiClass.class, initialClass);
  }

  public TreeLogtalkClassChooserDialog(String title,
  ...
  public static TreeLogtalkClassChooserDialog withInnerClasses(String title,
                                                            @NotNull Project project,
                                                            GlobalSearchScope scope,
                                                            final ClassFilter classFilter,
                                                            @Nullable PsiClass initialClass) {
    return new TreeLogtalkClassChooserDialog(title, project, scope, classFilter, null, initialClass, true);
  }
  ...
  protected List<PsiClass> getClassesByName(final String name,
    ...
    List<LogtalkComponent> components = LogtalkComponentIndex.getItemsByName(name, getProject(), searchScope);
    List<PsiClass> classes = new ArrayList<PsiClass>();

    for (LogtalkComponent component : components) {
