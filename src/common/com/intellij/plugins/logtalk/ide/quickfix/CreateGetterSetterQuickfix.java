 ...
 */
package com.intellij.plugins.logtalk.ide.quickfix;
...
public class CreateGetterSetterQuickfix extends BaseIntentionAction {
  private final LogtalkClassModel classModel;
  private final LogtalkFieldModel field;
  private final Boolean generateGetter;

  public CreateGetterSetterQuickfix(LogtalkClassModel classModel, LogtalkFieldModel field, Boolean generateGetter) {
      ...
      new Runnable() {
        ...
        public void run() {
          ...
          new WriteCommandAction.Simple(project) {
            @Override
            public void run() {
              List<LogtalkNamedComponent> elements =
                LogtalkElementGenerator.createNamedSubComponentsFromText(project, builder.toString());
