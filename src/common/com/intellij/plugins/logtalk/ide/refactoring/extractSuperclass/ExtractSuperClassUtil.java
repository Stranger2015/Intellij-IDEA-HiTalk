 ...
 */
package com.intellij.plugins.logtalk.ide.refactoring.extractSuperclass;
...
import com.intellij.plugins.haxe.ide.LogtalkFileTemplateUtil;
...
import com.intellij.plugins.haxe.lang.psi.LogtalkInheritList;
import com.intellij.plugins.logtalk.ide.LogtalkFileTemplateUtil;
import com.intellij.plugins.logtalk.ide.refactoring.memberPullUp.PullUpProcessor;
...
public class ExtractSuperClassUtil {
  ...
  public static PsiClass extractSuperClass(final Project project,
    ...
    //PsiClass superclass = CreateClassUtil.createClassFromCustomTemplate(targetDirectory, modules[0], superclassName, "LogtalkClass.hx.ft");
    ...
    try {
      LogtalkFile haxeFile = (LogtalkFile)LogtalkFileTemplateUtil
        .createClass(superclassName, packageName, targetDirectory, "LogtalkClass", null);
    ...
    try {
      ...
      if (PsiTreeUtil.getChildOfType(subclass, LogtalkInheritList.class) == null) {
