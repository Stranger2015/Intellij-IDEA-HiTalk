 ...
 * User: Fedor.Korotkov
 */
public class LogtalkIntroduceDialog extends DialogWrapper {
  ...
  private final LogtalkExpression myExpression;

  public LogtalkIntroduceDialog(@NotNull final Project project,
  ...
  private void setUpNameComboBox(Collection<String> possibleNames) {
    final EditorComboBoxEditor comboEditor = new StringComboboxEditor(myProject, LogtalkFileType.HAXE_FILE_TYPE, myNameComboBox);
  ...
  public LogtalkExpression getExpression() {
    return myExpression;
  }
