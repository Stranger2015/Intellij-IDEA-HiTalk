 ...
 */
public class LogtalkPullUpDialog extends PullUpDialogBase<MemberInfoStorage, MemberInfo, PsiMember, PsiClass> {
  ...
  public interface Callback {
    boolean checkConflicts(LogtalkPullUpDialog dialog);
  }

  public LogtalkPullUpDialog(Project project, PsiClass aClass, List<PsiClass> superClasses, MemberInfoStorage memberInfoStorage, Callback callback) {
