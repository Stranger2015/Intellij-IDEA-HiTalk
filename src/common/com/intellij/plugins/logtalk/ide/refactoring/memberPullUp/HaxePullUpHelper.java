 ...
 */
public class LogtalkPullUpHelper implements PullUpHelper<MemberInfo> {
  private static final Logger LOG = Logger.getInstance(LogtalkPullUpHelper.class);
  ...
  public LogtalkPullUpHelper(PullUpData data) {
  ...
  private  void doMoveMethod(PsiSubstitutor substitutor, MemberInfo info) {
    ...
    boolean isOriginalMethodPrototype = method instanceof LogtalkFunctionPrototypeDeclarationWithAttributes;
    if (myIsTargetInterface || info.isToAbstract()) {
      ...
      if (superClassMethod != null && superClassMethod.hasModifierProperty(PsiModifier.ABSTRACT)) {
        ...
        methodCopy = LogtalkElementGenerator.createFunctionPrototypeDeclarationWithAttributes(myProject, methodCopy.getText().trim() + ";");
