...
public class LogtalkPushDownDialog extends RefactoringDialog {
  ...
  public LogtalkPushDownDialog(Project project, MemberInfo[] memberInfos, PsiClass aClass) {
    super(project, true);
  ...
  protected String getDimensionServiceKey() {
    return "#com.intellij.refactoring.memberPushDown.LogtalkPushDownDialog";
  }
