...
import com.intellij.plugins.haxe.lang.psi.LogtalkInterfaceDeclaration;
      ...
      if (member instanceof PsiField) {
        ...
        if (methodBySignature == null) {
          ...
          if (myClass.isInterface()) {
            if (!(targetClass instanceof LogtalkInterfaceDeclaration)) {
              ...
              LogtalkFunctionDeclarationWithAttributes functionDeclarationWithAttributes =
                LogtalkElementGenerator.createFunctionDeclarationWithAttributes(myProject, text);
