...
import com.intellij.plugins.haxe.lang.psi.LogtalkDoWhileStatement;
 ...
 */
public class LogtalkDoWhileSurrounder extends LogtalkManyStatementsSurrounder {
  @NotNull
  @Override
  protected PsiElement doSurroundElements(PsiElement[] elements, PsiElement parent) {
    final LogtalkDoWhileStatement whileStatement =
      (LogtalkDoWhileStatement)LogtalkElementGenerator.createStatementFromText(elements[0].getProject(), "do {\n} while(a);");
  ...
  protected TextRange getSurroundSelectionRange(PsiElement element) {
    final List<LogtalkExpression> expressionList = LogtalkStatementUtils.getExpressionList(element);
    return expressionList.get(expressionList.size() - 1).getTextRange();
  }

  @Override
  public String getTemplateDescription() {
    return LogtalkBundle.message("logtalk.surrounder.do.while");
  }
}
