 ...
 */
public class LogtalkIfElseSurrounder extends LogtalkManyStatementsSurrounder {
  @NotNull
  @Override
  ...
  protected TextRange getSurroundSelectionRange(PsiElement element) {
    return null == element ? null : LogtalkStatementUtils.getExpression(element).getTextRange();
  }

  @Override
  public String getTemplateDescription() {
    return LogtalkBundle.message("logtalk.surrounder.if.else");
  }
}
