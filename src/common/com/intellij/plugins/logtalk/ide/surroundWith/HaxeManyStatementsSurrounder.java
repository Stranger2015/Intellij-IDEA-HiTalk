 ...
 */
public abstract class LogtalkManyStatementsSurrounder implements Surrounder {
  @Override
  public boolean isApplicable(@NotNull PsiElement[] elements) {
    if (elements.length == 0) return false;
    final PsiElement parent = elements[0].getParent();
    return parent instanceof LogtalkBlockStatement;
  }
  ...
  protected static void addStatements(LogtalkBlockStatement block, PsiElement[] elements) throws IncorrectOperationException {
