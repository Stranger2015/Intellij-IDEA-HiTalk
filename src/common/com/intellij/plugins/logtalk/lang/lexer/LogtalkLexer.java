...
public class LogtalkLexer extends LookAheadLexer {
  ...
  public LogtalkLexer(Project project) {
    super(new MergingLexerAdapter(new LogtalkFlexLexer(project), tokensToMerge));
    myProject = project;
  }
}