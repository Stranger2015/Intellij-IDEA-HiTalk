...
public interface LogtalkTokenTypeSets {
  IFileElementType LOGTALK_FILE = new IFileElementType("LOGTALK_FILE", LogtalkLanguage.INSTANCE);
  IElementType MSL_COMMENT = new LogtalkElementType("MSL_COMMENT");
  IElementType MML_COMMENT = new LogtalkElementType("MML_COMMENT");
  IElementType DOC_COMMENT = new LogtalkElementType("DOC_COMMENT");

  IElementType PPEXPRESSION = new LogtalkElementType("PPEXPRESSION");
  IElementType PPBODY = new LogtalkElementType("PPBODY");

  IElementType WSNLS = new LogtalkElementType("WSNLS");
