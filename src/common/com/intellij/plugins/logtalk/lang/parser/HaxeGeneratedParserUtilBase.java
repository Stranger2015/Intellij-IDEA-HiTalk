...
public class LogtalkGeneratedParserUtilBase extends GeneratedParserUtilBase {
  ...
  public static boolean semicolonUnlessPrecededByStatement(PsiBuilder builder_, int level) {
    ...
    if ((previousType == LogtalkTokenTypes.PRCURLY) || (previousType == LogtalkTokenTypes.OSEMI)) {
      return true;
    }
    builder_.error(LogtalkBundle.message("parsing.error.missing.semi.colon"));
    return false;
  }
