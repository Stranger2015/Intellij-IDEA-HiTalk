...
import com.intellij.plugins.haxe.lang.lexer.LogtalkLexer;
...
public class LogtalkParserDefinition implements ParserDefinition {

  @NotNull
  public Lexer createLexer(Project project) {
    return new LogtalkLexer(project);
  }

  public PsiParser createParser(Project project) {
    return new LogtalkParserWrapper();
  }

  public IFileElementType getFileNodeType() {
    return LogtalkTokenTypeSets.HAXE_FILE;
  }

  @NotNull
  public TokenSet getWhitespaceTokens() {
    return LogtalkTokenTypeSets.WHITESPACES;
  }

  @NotNull
  public TokenSet getCommentTokens() {
    return LogtalkTokenTypeSets.COMMENTS;
  }

  @NotNull
  public TokenSet getStringLiteralElements() {
    return LogtalkTokenTypeSets.STRINGS;
  }

  @NotNull
  public PsiElement createElement(ASTNode node) {
    return LogtalkTokenTypes.Factory.createElement(node);
  }
