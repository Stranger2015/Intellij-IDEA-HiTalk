...
public class LogtalkParserWrapper extends LogtalkParser {

  private static Logger LOG = Logger.getInstance("#LogtalkParserWrapper");
  ...
  public ASTNode parse(IElementType t, PsiBuilder b) {
    if (debugging) {
      LogtalkDebugTimeLog timeLog = null;
      ...
      timeLog = LogtalkDebugTimeLog.startNew("LogtalkParser " + description, LogtalkDebugTimeLog.Since.StartAndPrevious);
