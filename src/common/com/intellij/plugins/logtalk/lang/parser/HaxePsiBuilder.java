...
public class LogtalkPsiBuilder extends PsiBuilderImpl {

  private static final Logger LOG = Logger.getLogger("#LogtalkPsiBuilder");

  private static final HashSet<String> reportedErrors = new HashSet<String>();

  private final PsiFile psiFile;

  public LogtalkPsiBuilder(@NotNull ParserDefinition parserDefinition,
                        @NotNull Lexer lexer,
  ...
  public LogtalkPsiBuilder(@NotNull Project project,
