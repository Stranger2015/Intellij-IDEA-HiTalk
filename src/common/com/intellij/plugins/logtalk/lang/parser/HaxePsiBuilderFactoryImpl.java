 ...
 * LogtalkPsiBuilder will be used as the only PSIBuilder when this is installed.
 *
 ...
 *                     serviceImplementation="com.intellij.plugins.logtalk.lang.parser.LogtalkPsiBuilderFactoryImpl"/>
 *
 */
public class LogtalkPsiBuilderFactoryImpl extends PsiBuilderFactory {
  ...
  public PsiBuilder createBuilder(@NotNull final Project project,
    ...
    return new LogtalkPsiBuilder(project, parserDefinition, lexer != null ? lexer : createLexer(project, lang), chameleon, seq);
  }
  ...
  public PsiBuilder createBuilder(@NotNull final Project project, @NotNull final LighterLazyParseableNode chameleon) {
    ...
    return new LogtalkPsiBuilder(project, parserDefinition, createLexer(project, language), chameleon, chameleon.getText());
  }
  ...
  public PsiBuilder createBuilder(@NotNull final ParserDefinition parserDefinition,
                                  ...
                                  @NotNull final CharSequence seq) {
    return new LogtalkPsiBuilder(parserDefinition, lexer, seq);
  }
