 ...
 * to be both a statement and an AbstractLogtalkNamedComponent.  The
 ...
 * -- doesn't fail.
 * See LogtalkPsiCompositeElementImpl.getDeclarationToProcess() to see how
 * that works.
 */
public interface LogtalkForStatementPsiMixin extends LogtalkStatementPsiMixin, PsiNameIdentifierOwner {
