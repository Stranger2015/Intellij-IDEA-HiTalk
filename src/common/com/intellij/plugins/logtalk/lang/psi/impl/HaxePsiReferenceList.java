 ...
 */
public class LogtalkPsiReferenceList extends PsiReferenceListImpl implements PsiReferenceList {

  private Role mRole;
  private LogtalkClass mContainingClass;
  private List<PsiElement> mChildren;

  public LogtalkPsiReferenceList(ASTNode node) {
    super(node);
    mRole = null;
  ...
  public LogtalkPsiReferenceList(PsiClass containingClass, ASTNode node, Role inRole) {
    super(node);
    mRole = inRole;
    mContainingClass = (LogtalkClass) containingClass;
    mChildren = new ArrayList<PsiElement>();
  }
