 ...
 */
public class LogtalkPsiTokenImpl extends PsiJavaTokenImpl implements LogtalkPsiToken {

  public LogtalkPsiTokenImpl(IElementType type, CharSequence text) {
    super(type, text);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder("LogtalkPsiToken:");
