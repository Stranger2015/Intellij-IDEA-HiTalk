...
import com.intellij.plugins.haxe.lang.psi.LogtalkTypeParam;
...
/**
 * A class to encapsulate/override PsiType so that its interface can be used with Logtalk.
 *
 ...
 */
public class LogtalkPsiTypeAdapter extends PsiType implements LogtalkType {

  static final Logger LOG = Logger.getInstance("#com.intellij.plugins.logtalk.lang.psi.impl.LogtalkPsiTypeAdapter");
  static {
  ...
  LogtalkType myType = null;

  public LogtalkPsiTypeAdapter(@NotNull LogtalkType haxeType) {
    // Logtalk doesn't use annotations in the same way that Java does.  Instead, they're all
  ...
  public static final LogtalkPsiTypeAdapter[] EMPTY_ARRAY = new LogtalkPsiTypeAdapter[0];
  public static final ArrayFactory<LogtalkPsiTypeAdapter> ARRAY_FACTORY = new ArrayFactory<LogtalkPsiTypeAdapter>() {
    @NotNull
    @Override
    public LogtalkPsiTypeAdapter[] create(int count) {
      return count == 0 ? EMPTY_ARRAY : new LogtalkPsiTypeAdapter[count];
    }
  };

  @NotNull
  public static LogtalkPsiTypeAdapter[] createArray(int count) {
  ...
  public PsiArrayType createArrayType() {
    ...
    // TODO: Implement LogtalkPsiAdapter.createArrayType
    LOG.debug("Implement LogtalkPsiAdapter.createArrayType");
  ...
  public boolean isAssignableFrom(@NotNull PsiType type) {
    ...
    // TODO: Implement LogtalkPsiAdapter.isAssignableFrom
    LOG.debug("Implement LogtalkPsiAdapter.isAssignableFrom()");
  ...
  public boolean isConvertibleFrom(@NotNull PsiType type) {
    ...
    // TODO: Implement LogtalkPsiAdapter.isConvertibleFrom
    LOG.debug("Implement LogtalkPsiAdapter.isConvertibleFrom()");
  ...
  public PsiType[] getSuperTypes() {
    // TODO: Verify that we don't need to find supertypes through LogtalkPsiTypeAdapter.getSuperTypes().
  ...
  public PsiAnnotation[] getAnnotations() {
    // TODO: ?? Find and convert modifiers to annotations for LogtalkPsiTypeAdapter.getAnnotations() ??
    return PsiAnnotation.EMPTY_ARRAY;
  }

  @Override
  public PsiAnnotation findAnnotation(@NotNull @NonNls String qualifiedName) {
    // TODO: ?? Find and convert modifiers to annotations for LogtalkPsiTypeAdapter.findAnnotation() ??
  ...
  public String toString() {
    return "LogtalkPsiTypeAdapter:" + getPresentableText();
  }

  @Override
  public <A> A accept(@NotNull PsiTypeVisitor<A> visitor) {
    // TODO: Figure out what accept is supposed to do for LogtalkPsiTypeAdapter.
    LOG.debug("Unimplemented LogtalkPsiTypeAdapter.accept(PsiTypeVisitor<A>) was called.");
  ...
  @Nullable
  @Override
  public LogtalkTypeParam getTypeParam() {
  ...
  public PsiElement copy() {
    return (LogtalkPsiTypeAdapter)((LogtalkType)myType.copy()).getPsiType();
  }
  ...
  public PsiElement replace(@NotNull PsiElement newElement) throws IncorrectOperationException {
    // XXX: Might need to return a PsiType for it, if it's a LogtalkType.
