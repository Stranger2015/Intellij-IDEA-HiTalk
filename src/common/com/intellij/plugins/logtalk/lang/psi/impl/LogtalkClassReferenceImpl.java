 ...
 */
public abstract class LogtalkClassReferenceImpl extends LogtalkReferenceImpl {

  public static LogtalkDebugLogger LOG = LogtalkDebugLogger.getLogger();
  //static { LOG.setLevel(Level.DEBUG); }  // Remove when finished debugging.

  public LogtalkClassReferenceImpl(ASTNode node) {
    super(node);
  }
  ...
  public LogtalkClassResolveResult resolveLogtalkClass() {
    ...
    final LogtalkFunctionType functionType = PsiTreeUtil.getChildOfType(this, LogtalkFunctionType.class);
    LogtalkTypeOrAnonymous typeOrAnonymous = PsiTreeUtil.getChildOfType(this, LogtalkTypeOrAnonymous.class);
    ...
    final LogtalkType type = typeOrAnonymous != null ? typeOrAnonymous.getType() : PsiTreeUtil.getChildOfType(this, LogtalkType.class);
