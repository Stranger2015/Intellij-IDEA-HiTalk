...
import com.intellij.plugins.haxe.lang.parser.LogtalkParser;
import com.intellij.plugins.haxe.lang.psi.LogtalkExpressionCodeFragment;
import com.intellij.plugins.haxe.lang.psi.LogtalkFile;
import com.intellij.plugins.logtalk.LogtalkLanguage;
import com.intellij.plugins.logtalk.lang.psi.LogtalkExpressionCodeFragment;
 ...
 */
public class LogtalkExpressionCodeFragmentImpl extends LogtalkFile implements LogtalkExpressionCodeFragment {
  private PsiElement myContext;
  private boolean myPhysical;
  private FileViewProvider myViewProvider;
  private GlobalSearchScope myScope = null;

  public LogtalkExpressionCodeFragmentImpl(Project project,
                                        @NonNls String name,
                                        CharSequence text,
                                        boolean isPhysical) {
    ...
    final MyLogtalkFileElementType type = new MyLogtalkFileElementType();
    init(type, type);
  }
  ...
  protected LogtalkExpressionCodeFragmentImpl clone() {
    final LogtalkExpressionCodeFragmentImpl clone = (LogtalkExpressionCodeFragmentImpl)cloneImpl((FileElement)calcTreeElement().clone());
  ...
  private class MyLogtalkFileElementType extends IFileElementType {
    public MyLogtalkFileElementType() {
    ...
    public ASTNode parseContents(final ASTNode chameleon) {
      final PsiElement psi = new LogtalkPsiCompositeElementImpl(chameleon);
    ...
    protected ASTNode doParseContents(@NotNull ASTNode chameleon, @NotNull PsiElement psi) {
      ...
      final PsiBuilder builder = adapt_builder_(LogtalkTokenTypes.EXPRESSION, psiBuilder, new LogtalkParser());

      final PsiBuilder.Marker marker = enter_section_(builder, 0, _NONE_, "<code fragment>");
      LogtalkParser.expression(builder, 1);
      while (builder.getTokenType() != null) {
        builder.advanceLexer();
      }
      marker.done(LogtalkTokenTypes.EXPRESSION);
