 ...
 */
public class LogtalkPsiDocComment extends PsiDocCommentImpl implements PsiDocComment {

  private LogtalkNamedComponent mOwnerComponent;

  public LogtalkPsiDocComment(@NotNull LogtalkNamedComponent owner, @NotNull PsiComment comment) {
  ...
  public PsiDocCommentOwner getOwner() {
    ...
    // LogtalkXXX component owners that are not yet adapted to PsiXXX
    return null;
  }
