 ...
 */
public class LogtalkAstUtil {
  private LogtalkAstUtil() {}
  ...
  private final static Pattern octInteger = Pattern.compile("0[0-7]+");  // Logtalk doesn't understand the unary MINUS in PP
  ...
  public static boolean isWhitespace(@Nullable ASTNode t) {
    return null != t && LogtalkTokenTypeSets.WHITESPACES.contains(t.getElementType());
  }
