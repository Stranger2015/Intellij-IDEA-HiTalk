 ...
 * Logtalk uses the C precedence rules for operators.
 *
 * Created by ebishton on 3/31/17.
 */
public class LogtalkOperatorPrecedenceTable {
  ...
  static final LogtalkOperatorPrecedenceTable singleton = new LogtalkOperatorPrecedenceTable();

  //public static LogtalkOperatorPrecedenceTable instance() {
  //  return singleton;
  //}
  ...
  private LogtalkOperatorPrecedenceTable() {
    ...
    // ========================================================================================
    // Parens (function calls), [] brackets, . member selection, -> member selection via pointer (not Logtalk),
    ...
    // (cast) type cast , * dereference via pointer (not Logtalk), & addressOf (not Logtalk), sizeof (not Logtalk)
