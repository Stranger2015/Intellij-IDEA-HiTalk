 ...
 */
public class LogtalkLibraryInfo {
  final public String name;
  final public LogtalklibSemVer semver;
  final public String relativeClasspath;


  LogtalkLibraryInfo(@NotNull String name, @NotNull String semver, @Nullable String relativeClasspath) {
    this(name,
         LogtalklibSemVer.create(semver),
         null != relativeClasspath ? relativeClasspath : ".");
  }

  LogtalkLibraryInfo(@NotNull String name, @NotNull LogtalklibSemVer semver, @NotNull String relativeClasspath) {
    this.name = name;
    this.semver = semver;
