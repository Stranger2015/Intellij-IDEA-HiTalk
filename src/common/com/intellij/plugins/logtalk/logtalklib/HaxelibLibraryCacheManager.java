 ...
 * LogtalklibLibraryManager is an option.  This implementation just allowed for
 ...
 */
public class LogtalklibLibraryCacheManager {
  ...
  public LogtalklibLibraryCacheManager() {
   ...
   */
  @NotNull
  public LogtalklibLibraryCache getLibraryManager(@NotNull Module module) {
   ...
   */
  @NotNull
  public LogtalklibLibraryCache getLibraryCache(@NotNull Sdk sdk) {
  ...
  final class SdkEntry {
    final Sdk mySdk;
    final LogtalklibLibraryCache myMgr;

    public SdkEntry(@NotNull Sdk sdk) {
      mySdk = sdk;
      myMgr = new LogtalklibLibraryCache(sdk);
    }
    ...
    @NotNull
    public LogtalklibLibraryCache getLibraryCache() {
      return myMgr;
    }
