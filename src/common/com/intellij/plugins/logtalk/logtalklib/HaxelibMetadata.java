 ...
 */
public class LogtalklibMetadata {
  ...
  public static LogtalklibMetadata EMPTY_METADATA = new LogtalklibMetadata(true);
  ...
  private LogtalklibMetadata(boolean makeEmpty) {
    root = null;
    path = "";
  }

  /** Test constructor */
  public LogtalklibMetadata(@NotNull String json) {
    root = parse(json);
    path = "";
  }

  private LogtalklibMetadata(@NotNull VirtualFile jsonFile) {
    try {
  ...
  @NotNull
  public static LogtalklibMetadata load(@NotNull VirtualFile libRoot) {
    String mdfile = LogtalkFileUtil.joinPath(libRoot.getUrl(), "haxelib.json");
    VirtualFile metadatafile = VirtualFileManager.getInstance().findFileByUrl(mdfile);
    if (null == metadatafile || !metadatafile.exists()) {
      return EMPTY_METADATA;
    }
    return new LogtalklibMetadata(metadatafile);
  }
  ...
  public boolean equals(Object o) {
    ...
    LogtalklibMetadata metadata = (LogtalklibMetadata)o;
