 ...
 */
public final class LogtalklibNameUtil {
  ...
  public static String stringifyLogtalklib(LogtalklibItem haxelibItem) {
  ...
  public static String stringifyLogtalklib(String path) {
    synchronized(gSB) {
  ...
  @Nullable
  public static String parseLogtalklib(@Nullable String data) {
  ...
  public static boolean isManagedLibrary(String name) {
    return name.startsWith(startsWith); // null != parseLogtalklib(data);
  }
   ...
   */
  @Nullable
  public static String parseLogtalklibNameFromPath(@NotNull String classpathUrl) {
