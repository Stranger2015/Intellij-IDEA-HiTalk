 ...
 */
public class LogtalklibSdkUtils {

  // TODO: Move these routines into LogtalkSdkUtil and kill this class.

  private static final Logger LOG = Logger.getInstance("#com.intellij.plugin.logtalk.haxelib.LogtalklibSdkUtils");
  ...
  static {
    LogtalkSdkType sdkType = LogtalkSdkType.getInstance();
  ...
  public static Sdk lookupSdk(@NotNull Module module) {
    ...
    if (null == sdk) {
      // TODO: Move error string to a resource in LogtalkBundle.
