...
/**
 * Manage semantic versioning according to Logtalk library rules.  (See the 'haxelib' tool
 * and conditional compilation comparison rules.)
 */
public class LogtalklibSemVer {

  public static class ConstantVer extends LogtalklibSemVer {
    public final String name;
    public ConstantVer(int major, int minor, int patch, String name) {
      super(major, minor, patch);
      this.name = name;
    }
    @Override public boolean matchesRequestedVersion(LogtalklibSemVer requestedVersion) { return true; }
  ...
  public static final LogtalklibSemVer ZERO_VERSION = new LogtalklibSemVer(0,0,0);
  ...
  private LogtalklibSemVer(int major, int minor, int patch) {
    this.major = major;
    this.minor = minor;
    this.patch = patch;
  }
   ...
   */
  @NotNull
  public static LogtalklibSemVer create(@Nullable String semver) {
    ...
    return new LogtalklibSemVer(Integer.parseInt(matcher.group(1)),
   ...
   * @return
   */
  public boolean matchesRequestedVersion(LogtalklibSemVer requestedVersion) {
  ...
  /**
   * Converts this version into a float for comparison according to Logtalk's rules.
  ...
  public String toDirString() {
    return LogtalkStringUtil.join(",", Integer.toString(major), Integer.toString(minor), Integer.toString(patch));
  }
  ...
  public boolean equals(Object o) {
    ...
    LogtalklibSemVer ver = (LogtalklibSemVer)o;
