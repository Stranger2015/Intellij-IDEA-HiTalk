...
public class LogtalkSourceRootModel {
  public static final LogtalkSourceRootModel DUMMY = new LogtalkSourceRootModel(null, null);
  public final LogtalkProjectModel project;
  public final VirtualFile root;
  public final PsiDirectory directory;
  private final LogtalkPackageModel rootPackage;

  public LogtalkSourceRootModel(LogtalkProjectModel projectModel, VirtualFile root) {
    ...
    if (project == null || root == null) {
      ...
      rootPackage = new LogtalkPackageModel(this, "", null);
    }
  }
