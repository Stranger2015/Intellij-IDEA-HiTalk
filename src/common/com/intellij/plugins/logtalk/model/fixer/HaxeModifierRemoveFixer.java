...
public class LogtalkModifierRemoveFixer extends LogtalkFixer {
  private LogtalkModifiersModel modifiers;
  private LogtalkModifierType modifier;

  public LogtalkModifierRemoveFixer(LogtalkModifiersModel modifiers, LogtalkModifierType modifier) {
    this(modifiers, modifier, "Remove " + modifier.s);
  }

  public LogtalkModifierRemoveFixer(LogtalkModifiersModel modifiers, LogtalkModifierType modifier, String string) {
    super(string);
