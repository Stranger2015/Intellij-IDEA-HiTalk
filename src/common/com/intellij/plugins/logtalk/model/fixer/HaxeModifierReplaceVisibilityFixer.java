...
public class LogtalkModifierReplaceVisibilityFixer extends LogtalkFixer {
  private LogtalkModifiersModel modifiers;
  private LogtalkModifierType visibility;

  public LogtalkModifierReplaceVisibilityFixer(LogtalkModifiersModel modifiers, LogtalkModifierType visibility) {
    this(modifiers, visibility, "Remove " + visibility.s);
  }

  public LogtalkModifierReplaceVisibilityFixer(LogtalkModifiersModel modifiers, LogtalkModifierType visibility, String text) {
    super(text);
