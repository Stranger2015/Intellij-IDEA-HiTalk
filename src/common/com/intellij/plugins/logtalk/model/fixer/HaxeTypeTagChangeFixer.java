...
public class LogtalkTypeTagChangeFixer extends LogtalkFixer {
  private LogtalkTypeTag typeTag;
  private SpecificTypeReference result;

  public LogtalkTypeTagChangeFixer(LogtalkTypeTag typeTag, SpecificTypeReference result) {
    super("LogtalkTypeTagChangeFixer");
  ...
  @Override
  public void run() {
    LogtalkDocumentModel.fromElement(typeTag).replaceElementText(
      typeTag,
