...
public class ResultHolder {
  ...
  @Nullable
  public SpecificLogtalkClassReference getClassType() {
    return (type instanceof SpecificLogtalkClassReference) ? (SpecificLogtalkClassReference)type : null;
  }
  ...
  public boolean canAssign(ResultHolder that) {
    return LogtalkTypeCompatible.canAssignToFrom(this, that);
  }
