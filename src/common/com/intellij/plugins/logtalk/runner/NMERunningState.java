...
public class NMERunningState extends CommandLineState {
  ...
  protected ProcessHandler startProcess() throws ExecutionException {
    ...
    LogtalkCommandLine commandLine = getCommandForNeko(sdk, settings);

    return new ColoredProcessHandler(commandLine.createProcess(), commandLine.getCommandLineString());
  }

  private LogtalkCommandLine getCommandForNeko(Sdk sdk, LogtalkModuleSettings settings) throws ExecutionException {
