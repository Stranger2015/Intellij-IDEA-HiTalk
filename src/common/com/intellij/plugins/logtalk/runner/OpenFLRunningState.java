...
public class OpenFLRunningState extends CommandLineState {
  ...
  protected ProcessHandler startProcess() throws ExecutionException {
    ...
    LogtalkCommandLine commandLine = getCommandForOpenFL(sdk, settings);

    return new ColoredProcessHandler(commandLine.createProcess(), commandLine.getCommandLineString());
  }

  private LogtalkCommandLine getCommandForOpenFL(Sdk sdk, LogtalkModuleSettings settings) throws ExecutionException {
    ...
    if (sdkData == null) {
      throw new ExecutionException(LogtalkCommonBundle.message("invalid.logtalk.sdk"));
    }
    final LogtalkCommandLine commandLine = new LogtalkCommandLine(module);

    commandLine.setWorkDirectory(PathUtil.getParentPath(module.getModuleFilePath()));
    final String haxelibPath = sdkData.getLogtalklibPath();
    if (haxelibPath == null || haxelibPath.isEmpty()) {
      throw new ExecutionException(LogtalkCommonBundle.message("no.haxelib.for.sdk", sdk.getName()));
    }
