 ...
 */
public class LogtalkBreakpointType extends XLineBreakpointType<XBreakpointProperties> {

  public static class LogtalkBreakpointTypeProvider implements FlexBreakpointsHandler.BreakpointTypeProvider {
    public Class<? extends XBreakpointType<XLineBreakpoint<XBreakpointProperties>, ?>> getBreakpointTypeClass() {
      return LogtalkBreakpointType.class;
    }
  }

  private final XDebuggerEditorsProvider myEditorProvider = new LogtalkDebuggerEditorsProvider();

  protected LogtalkBreakpointType() {
    super("Logtalk", LogtalkBundle.message("logtalk.break.point.title"));
  }

  public boolean canPutAt(@NotNull final VirtualFile file, final int line, @NotNull Project project) {
    return file.getFileType() == LogtalkFileType.HAXE_FILE_TYPE;
  }
