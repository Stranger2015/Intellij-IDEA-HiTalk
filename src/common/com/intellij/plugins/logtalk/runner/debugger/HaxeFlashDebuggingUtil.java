 ...
 */
public class LogtalkFlashDebuggingUtil {
  public static RunContentDescriptor getDescriptor(final Module module,
    ...
    if (flexSdk == null) {
      throw new ExecutionException(LogtalkBundle.message("flex.sdk.not.found", flexSdkName));
    }
      ...
      XDebuggerManager.getInstance(module.getProject()).startSession(env, new XDebugProcessStarter() {
        ...
        public XDebugProcess start(@NotNull final XDebugSession session) throws ExecutionException {
          try {
            ...
            return new LogtalkDebugProcess(session, bc, params);
          }
          catch (IOException e) {
  ...
  public static RunContentDescriptor getNMEDescriptor(final LogtalkDebugRunner runner,
                                                      final Module module,
  ...
  public static RunContentDescriptor getOpenFLDescriptor(final LogtalkDebugRunner runner,
                                                         final Module module,
                                                         final ExecutionEnvironment env,
                                                         final Executor executor, String flexSdkName) throws ExecutionException {
    final Sdk flexSdk = FlexSdkUtils.findFlexOrFlexmojosSdk(flexSdkName);
