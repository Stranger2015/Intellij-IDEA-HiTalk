 ...
 */
package com.intellij.plugins.logtalk.runner.ui;
...
public class LogtalkRunConfigurationEditorForm extends SettingsEditor<LogtalkApplicationConfiguration> {
  ...
  public LogtalkRunConfigurationEditorForm(Project project) {
    this.project = project;
  }

  @Override
  protected void resetEditorFrom(LogtalkApplicationConfiguration configuration) {
  ...
  private void updateCustomPathToFile() {
    if (myCustomPathCheckBox.isSelected()) {
      ...
      final LogtalkModuleSettings settings = LogtalkModuleSettings.getInstance(getSelectedModule());
  ...
  @Override
  protected void applyEditorTo(LogtalkApplicationConfiguration configuration) throws ConfigurationException {
