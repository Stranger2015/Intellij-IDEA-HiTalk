...
import com.intellij.plugins.logtalk.tests.runner.filters.ErrorFilter;
import com.intellij.util.PathUtil;
import org.jetbrains.annotations.NotNull;

;

public class LogtalkTestsRunner extends DefaultProgramRunner {

  public static final String HAXE_TESTS_RUNNER_ID = "LogtalkTestsRunner";
  ...
  public boolean canRun(@NotNull String executorId, @NotNull RunProfile profile) {
    return DefaultRunExecutor.EXECUTOR_ID.equals(executorId) && profile instanceof LogtalkTestsConfiguration;
  }
  ...
  protected RunContentDescriptor doExecute(@NotNull final Project project,
    ...
    final LogtalkTestsConfiguration profile = (LogtalkTestsConfiguration)environment.getRunProfile();
    ...
    return super.doExecute(project, new CommandLineState(environment) {
      ...
      protected ProcessHandler startProcess() throws ExecutionException {
        ...
        LogtalkTarget currentTarget = LogtalkTarget.NEKO;
      ...
      private String getFileNameWithCurrentExtension(LogtalkTarget haxeTarget, String fileName) {
        if (haxeTarget != null) {
