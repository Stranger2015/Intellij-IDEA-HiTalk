 ...
 */
public final class LogtalkDebugTimeLog {

  // For logging issues with this class.
  final Logger LOG = Logger.getInstance("#com.intellij.plugins.logtalk.util.LogtalkDebugTimeLog");
  ...
  public LogtalkDebugTimeLog(@Nullable String messagePrefix) {
    this(messagePrefix, Since.StartAndPrevious);
  }

  public LogtalkDebugTimeLog(@Nullable String messagePrefix, Since since) {
    this(Logger.getInstance(messagePrefix), since);
    myLog.setLevel(Level.DEBUG);
  }

  public LogtalkDebugTimeLog(@NotNull Logger log, Since since) {
    myLog = log;
   ...
   */
  @NotNull
  static public LogtalkDebugTimeLog startNew(@NotNull String prefix) {
   ...
   */
  @NotNull
  static public LogtalkDebugTimeLog startNew(@NotNull String prefix, Since since) {
    LogtalkDebugTimeLog log = new LogtalkDebugTimeLog(prefix, since);
    log.stamp("Start");
    return log;
  }
   ...
   *
   * @param message text to identify the message.
   * @param since output control of elapsed time (See LogtalkDebugTimeLog.Since.)
   */
