...
public class LogtalkDebugUtil {
  ...
  private static String createTraceMessage(String message, int maxMessageLength, int depthAdjustment, boolean includeThreadId) {
    ...
    msg.append(LogtalkDebugUtil.getStackDepth() - depthAdjustment);
    msg.append(':');
    if (null != message) {
      msg.append(message);
    }
  ...
  public static class InvalidCaseException extends RuntimeException {
    public InvalidCaseException() {
      super(LogtalkBundle.message("invalid.case.value.unadorned"));
    }
    public InvalidCaseException(Object o) {
      super(LogtalkBundle.message("invalid.case.value", o.toString()));
    }
  }
  ...
  public static class InvalidValueException extends RuntimeException {
    ...
    private static String valueMessage(Object o) {
      return LogtalkBundle.message("invalid.value.detected.at.runtime", o.toString());
    }
  }
