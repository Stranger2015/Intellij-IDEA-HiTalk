 ...
 */
public class LogtalkModificationTracker {
  ...
  public LogtalkModificationTracker(String debugName) {
    debugCount++;
  ...
  public boolean isModifiedSince(LogtalkTrackedModifiable.Stamp s) {
    if (s instanceof LogtalkModificationTracker.Stamp) {
      return isModifiedSince((LogtalkModificationTracker.Stamp)s);
    }
  ...
  public class Stamp implements LogtalkTrackedModifiable.Stamp {
    private final int value;
    private final LogtalkModificationTracker tracker;

    private Stamp(int value) {
      this.value = value;
      this.tracker = LogtalkModificationTracker.this;
    }
