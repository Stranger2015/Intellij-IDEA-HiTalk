...
/**
 * Public-facing interface to objects managed by LogtalkModificationTracker.
 *
 * Created by ebishton on 9/7/2017.
 */
public interface LogtalkTrackedModifiable {
   ...
   * or LogtalkModificationTracker.isModifiedSince(Stamp) is recommended.
   *
  ...
  /**
   * Determines whether this LogtalkTrackedModifiable has been changed since the
   * stamp was taken.
   *
   * It is a run-time error (a LOG message will be issued) to test a Stamp against
   * a LogtalkModificationTracker other than the one that allocated it.
   *
