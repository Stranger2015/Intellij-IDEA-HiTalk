...
public class ThreadLocalCounter {
  ...
  public ThreadLocalCounter() {
    this(LogtalkDebugUtil.getCallerCanonicalName());
  }
  ...
  public int decrement() {
    ...
    counter.set(newval);
    if (newval < 0) {
      LOG.debug(LogtalkDebugUtil.traceThreadMessage(
        debugName + " decremented past zero by " + LogtalkDebugUtil.getCallerCanonicalName()));
    }
    return newval;
  }
