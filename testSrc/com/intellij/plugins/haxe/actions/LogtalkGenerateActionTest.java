 ...
 */
public class LogtalkGenerateActionTest extends LightPlatformCodeInsightTestCase {
  @SuppressWarnings("JUnitTestCaseWithNonTrivialConstructors")
  public LogtalkGenerateActionTest() {
  ...
  protected String getTestDataPath() {
    return LogtalkTestUtils.BASE_TEST_DATA_PATH + FileUtil.toSystemDependentName("/generate/");
  }

  protected void doOverrideTest() {
    doTest(new LogtalkOverrideMethodHandler());
  }

  protected void doImplementTest() {
    doTest(new LogtalkImplementMethodHandler());
  }

  protected void doConstructorTest() {
    configureByFile(getTestName(false) + ".hx");
    doTest(new LogtalkConstructorHandler());
  }

  protected void doGetterSetterTest(CreateGetterSetterFix.Strategy strategy) {
    configureByFile(getTestName(false) + ".hx");
    doTest(new LogtalkGenerateAccessorHandler(strategy) {
      @Override
  ...
  protected void doTest(BaseLogtalkGenerateHandler anAction) {
