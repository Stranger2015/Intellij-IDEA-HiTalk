 ...
 */
public class LogtalkSmartEnterTest extends LogtalkCodeInsightFixtureTestCase {
  @Override
  ...
  public void doTest() {
    ...
    final List<SmartEnterProcessor> processors = SmartEnterProcessors.INSTANCE.forKey(LogtalkLanguage.INSTANCE);
