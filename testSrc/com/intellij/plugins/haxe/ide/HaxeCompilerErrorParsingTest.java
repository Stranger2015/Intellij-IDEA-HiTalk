...
import com.intellij.plugins.logtalk.compilation.LogtalkCompilerError;
import junit.framework.TestCase;

/**
 * @author: Fedor.Korotkov
 */
public class LogtalkCompilerErrorParsingTest extends TestCase {
  // XXX this is an unsafe test to do on a non-windows box
  public void disabledtestUserProperiesErrorWin() {
    final String error =
      "C:/Users/fedor.korotkov/workspace/logtalk-bubble-breaker/src/Main.hx:5: characters 0-21 : Class not found : StringTools212";
    final String rootPath = "C:/Users/fedor.korotkov/workspace/logtalk-bubble-breaker";
    final LogtalkCompilerError compilerError = LogtalkCompilerError.create(rootPath, error, false);

    assertNotNull(compilerError);
    assertEquals(CompilerMessageCategory.ERROR, compilerError.getCategory());
    assertEquals("C:/Users/fedor.korotkov/workspace/logtalk-bubble-breaker/src/Main.hx", compilerError.getPath());
