...
import com.intellij.plugins.haxe.ide.projectStructure.detection.LogtalkProjectStructureDetector;
 ...
 */
public class LogtalkSourceRootDetectionTest extends PlatformTestCase {
  private void doTest(String... expected) {
    final String dirPath = FileUtil.toSystemDependentName(LogtalkTestUtils.BASE_TEST_DATA_PATH + "/rootDetection/") + getTestName(true);
    final File dir = new File(dirPath);
    assertTrue(dir.isDirectory());
    final LogtalkProjectStructureDetector haxeProjectStructureDetector = new LogtalkProjectStructureDetector();
