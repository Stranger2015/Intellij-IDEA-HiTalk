 ...
 */
public class LogtalkSurroundTest extends LogtalkCodeInsightFixtureTestCase {
  @Override
  ...
  private void setTestStyleSettings() {
    ...
    CodeStyleSettings.IndentOptions indentOptions = tempSettings.getIndentOptions(LogtalkFileType.HAXE_FILE_TYPE);
  ...
  public void testIf() throws Exception {
    doTest(new LogtalkIfSurrounder());
  }

  public void testIfElse() throws Exception {
    doTest(new LogtalkIfElseSurrounder());
  }

  public void testWhile() throws Exception {
    doTest(new LogtalkWhileSurrounder());
  }

  public void testDoWhile() throws Exception {
    doTest(new LogtalkDoWhileSurrounder());
  }

  public void testTryCatch() throws Exception {
    doTest(new LogtalkTryCatchSurrounder());
  }
}
