...
import com.intellij.plugins.haxe.ide.index.LogtalkSymbolIndex;
import com.intellij.psi.search.GlobalSearchScope;

import java.util.*;

public class LogtalkSymbolContributorTest extends LogtalkCodeInsightFixtureTestCase {
  @Override
  protected String getBasePath() {
    return "/indexers/symbols/";
  }

  public LogtalkSymbolContributorTest() {}
  ...
  protected void checkSymbols(List<String> list) {
    String[] symbols = LogtalkSymbolIndex.getAllSymbols(GlobalSearchScope.projectScope(myFixture.getProject()));
