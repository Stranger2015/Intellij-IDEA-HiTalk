...
/**
 * Test for the LogtalkDeprecatedInspection.
 * <p/>
 * Created by Usievaład Kimajeŭ on 7.06.2016.
 */
public class LogtalkDeprecatedInspectionTest extends LogtalkCodeInsightFixtureTestCase {
  ...
  private void doTest(String fileName) {
    ...
    myFixture.enableInspections(new LogtalkDeprecatedInspection());
