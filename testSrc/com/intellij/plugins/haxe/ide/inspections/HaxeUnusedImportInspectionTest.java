...
/**
 * Test for the LogtalkUnusedImportInspection.
 * <p/>
 * Created by Usievaład Kimajeŭ on 27.05.2016.
 */
public class LogtalkUnusedImportInspectionTest extends LogtalkCodeInsightFixtureTestCase {
  ...
  private void doTest(String fileName) {
    ...
    myFixture.enableInspections(new LogtalkUnusedImportInspection());
