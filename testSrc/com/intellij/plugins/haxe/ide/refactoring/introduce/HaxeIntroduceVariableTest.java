...
import com.intellij.plugins.haxe.lang.psi.LogtalkCallExpression;

/**
 * @author: Fedor.Korotkov
 */
public class LogtalkIntroduceVariableTest extends LogtalkIntroduceTestBase {
  @Override
  ...
  @Override
  protected LogtalkIntroduceHandler createHandler() {
  ...
  public void testSuggestName1() throws Throwable {
    doTestSuggestions(LogtalkCallExpression.class, "test");
  }

  public void testSuggestName2() throws Throwable {
    doTestSuggestions(LogtalkCallExpression.class, "test1");
  }
}
