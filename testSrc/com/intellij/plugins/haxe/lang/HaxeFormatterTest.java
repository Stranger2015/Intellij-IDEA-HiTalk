 ...
 */
public class LogtalkFormatterTest extends LogtalkCodeInsightFixtureTestCase {
  ...
  protected void defineStyleSettings(CodeStyleSettings tempSettings) {
    myTestStyleSettings = tempSettings.getCommonSettings(LogtalkLanguage.INSTANCE);
