...
import com.intellij.plugins.haxe.lang.util.LogtalkConditionalExpression;
...
public class ConditionalCompilationTest extends StatementTestBase {
  ...
  private void setDefines(String defines) {
    myProject.putUserData(LogtalkConditionalExpression.DEFINES_KEY, defines);
  }
  ...
  public void testComplexMultiExpressionWithParens() throws Throwable {
    ...
    setDefines("cpp=false,js=true,logtalk-ver=\"3.2\"");
    doTest(true);
  }
