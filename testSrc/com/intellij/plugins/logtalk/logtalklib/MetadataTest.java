...
import static com.intellij.plugins.logtalk.logtalklib.LogtalklibMetadata.*;
...
public class MetadataTest extends UsefulTestCase {
  ...
  private LogtalklibMetadata getTestMetadata() {
    String testdata = getTestString();
    LogtalklibMetadata md = new LogtalklibMetadata(testdata);
    return md;
  }
  ...
  public void testParsing() throws Exception {
    LogtalklibMetadata md = getTestMetadata();
  ...
  public void testAccessors() throws Exception {
    ...
    assertContains(md.getDependencies(),
                   new LogtalklibMetadata.Dependency(LIB_NAME1, LIB_VERSION1),
                   new LogtalklibMetadata.Dependency(LIB_NAME2, LIB_VERSION2));
  }
}
